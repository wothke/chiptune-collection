...
e.asm=ac;e.ccall=function(a,b,c,d){var f=e["_"+a];assert(f,"Cannot call unknown function "+a+", make sure it is exported");var g=[];a=0;if(d)for(var h=0;h<d.length;h++){var n=ra[c[h]];n?(0===a&&(a=la()),g[h]=n(d[h])):g[h]=d[h]}c=f.apply(null,g);"string"===b&&(c=C(c));0!==a&&ma(a);return c};e.getMemory=function(a){return fa?Ma?va(a):ha(a):ea(a)};e.Pointer_stringify=C;e.addRunDependency=Qa;e.removeRunDependency=Sa;e.FS_createFolder=Nb;e.FS_createPath=Ob;e.FS_createDataFile=Qb;
e.FS_createPreloadedFile=Ub;e.FS_createLazyFile=Tb;e.FS_createLink=Rb;e.FS_createDevice=V;e.FS_unlink=Eb;function u(a){this.name="ExitStatus";this.message="Program terminated with exit("+a+")";this.status=a}u.prototype=Error();u.prototype.constructor=u;var bc=null;Pa=function cc(){e.calledRun||dc();e.calledRun||(Pa=cc)};
