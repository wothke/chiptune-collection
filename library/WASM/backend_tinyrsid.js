...
return c}})();K=1024;L=K+281568;ea.push();a.STATIC_BASE=K;a.STATIC_BUMP=281568;L+=16;function la(b){return Math.pow(2,b)}assert(!M);var ma=L;L=L+4+15&-16;R=ma;N=O=w(L);P=N+T;Q=w(P);H[R>>2]=Q;M=!0;a.wasmTableSize=0;a.wasmMaxTableSize=0;a.b={};
a.c={enlargeMemory:function(){ca()},getTotalMemory:function(){return S},abortOnCannotGrowMemory:ca,___setErrNo:function(b){a.___errno_location&&(H[a.___errno_location()>>2]=b);return b},_emscripten_memcpy_big:function(b,d,e){D.set(D.subarray(d,d+e),b);return b},_llvm_exp2_f64:function(){return la.apply(null,arguments)},DYNAMICTOP_PTR:R,STACKTOP:O};var qa=a.asm(a.b,a.c,buffer);a.asm=qa;a._computeAudioSamples=function(){return a.asm._computeAudioSamples.apply(null,arguments)};
...
a.ccall=function(b,d,e,c){var g=a["_"+b];assert(g,"Cannot call unknown function "+b+", make sure it is exported");var h=[];b=0;if(c)for(var f=0;f<c.length;f++){var k=aa[e[f]];k?(0===b&&(b=z()),h[f]=k(c[f])):h[f]=c[f]}e=g.apply(null,h);"string"===d&&(e=ba(e));0!==b&&A(b);return e};function v(b){this.name="ExitStatus";this.message="Program terminated with exit("+b+")";this.status=b}v.prototype=Error();v.prototype.constructor=v;var ra=null;X=function sa(){a.calledRun||Z();a.calledRun||(X=sa)};
function Z(){function b(){if(!a.calledRun&&(a.calledRun=!0,!x)){ja||(ja=!0,U(ea));U(fa);if(a.onRuntimeInitialized)a.onRuntimeInitialized();if(a.postRun)for("function"==typeof a.postRun&&(a.postRun=[a.postRun]);a.postRun.length;){var b=a.postRun.shift();ia.unshift(b)}U(ia)}}null===ra&&(ra=Date.now());if(!(0<V)){if(a.preRun)for("function"==typeof a.preRun&&(a.preRun=[a.preRun]);a.preRun.length;)ka();U(da);0<V||a.calledRun||(a.setStatus?(a.setStatus("Running..."),setTimeout(function(){setTimeout(function(){a.setStatus("")},
